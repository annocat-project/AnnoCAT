...
function renderJobs(){
  if(taskControlsAreActive()){taskRenderPending=true;return}
...
function sourceLicenseNote(source){if(source.id==='hpo')return'<small class="source-license-note">Uses versioned HPO and MONDO releases. Review the <a href="https://human-phenotype-ontology.github.io/license.html" target="_blank" rel="noopener noreferrer">HPO terms</a> and <a href="https://mondo.monarchinitiative.org/pages/download/" target="_blank" rel="noopener noreferrer">MONDO CC BY 4.0 terms</a>.</small>';if(source.delivery==='managed-public-noncommercial')return'<small class="source-license-note">Non-commercial use; commercial use requires a CADD license.</small>';if(source.delivery==='user-supplied-licensed')return`<small class="source-license-note">Import files obtained under your ${escapeHtml(source.name)} license.</small>`;return''}
