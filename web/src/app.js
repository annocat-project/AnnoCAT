...
async function openCompletedRun(run,offset=0){
  ...
  if(switchingRun){
    ...
    resultView='all';
    const phenotypeProfilePromise=phenotypeFeature.sync(run,resourceStates).catch(error=>{console.error(error);return null});
